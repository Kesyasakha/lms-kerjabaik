...
import { InstructorChart } from "../komponen/InstructorChart";

export default function InstructorDashboard() {
  const { data: stats, isLoading: statsLoading } =
    useInstructorDashboardStats();
  const { data: activities, isLoading: activitiesLoading } =
    useRecentActivities(7);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Badge variant="outline" className="px-3 py-1 bg-white/50 backdrop-blur-sm shadow-sm border-gray-200 dark:border-gray-800">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="space-y-6">
          {/* Recent Activities */}
          <Card className="shadow-sm border border-gray-200 dark:border-gray-800 overflow-hidden h-fit">
            <CardHeader className="bg-muted/30 border-b py-4">
              <div className="flex items-center justify-between">
                <div>
      ...
      {/* My Courses */}
      <Card className="rounded-2xl shadow-none border border-gray-200 dark:border-gray-800 overflow-hidden">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {courses.map((course) => (
                <Link
                  ...
                  className="group"
                >
                  <Card className="h-full overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 border border-gray-200 dark:border-gray-800 hover:border-primary/50">
